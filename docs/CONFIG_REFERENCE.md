...
**慢教授公众号专题:** `SLOW_PROFESSOR_WECHAT_FEED_URL` 可填公网 WeWe/RSS 地址；专题文件为 `data/latest-slow-professor-3d.json`，只把 RSS/Atom 中最近 72 小时条目当作“近三日文章”。未配置公网源时，仅显示用户明确给过的微信原文作为“已确认入口”，不使用第三方转载页冒充公众号文章。
